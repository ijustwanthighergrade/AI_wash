...
r = requests.get(url,data,headers={'Authorization':'Token 84d880fe428b979e089e05847c5a3c7b20e3d2d0'})
...
#發送requset的code
# url="https://0e15-2001-b400-e339-80f8-cdfa-1872-3160-73a7.jp.ngrok.io/RESTapiApp/Line_2/"
# data={
...
# url="https://0e15-2001-b400-e339-80f8-cdfa-1872-3160-73a7.jp.ngrok.io/RESTapiApp/Access/"
# data={
...
# url1="https://0e15-2001-b400-e339-80f8-cdfa-1872-3160-73a7.jp.ngrok.io/RESTapiApp/SMS_1/"
# data={
#     'Rphone': '0908098950'
# }
# r = requests.get(url1,data,headers={'Authorization':'Token 84d880fe428b979e089e05847c5a3c7b20e3d2d0'})
# print(r.json()) 

# 簡訊第2步驟

# url2="https://0e15-2001-b400-e339-80f8-cdfa-1872-3160-73a7.jp.ngrok.io/RESTapiApp/SMS_2/"
# data={
#     'RSMSid': 'RSMSid-24bc695b-51ad-43af-9937-e7c7f301509f',
#     'RSMS_code' :'2315', 
#       #手機驗證碼
# }
# r = requests.get(url2,data,headers={'Authorization':'Token 84d880fe428b979e089e05847c5a3c7b20e3d2d0'})
# print(r.json()) 

# 簡訊第三步驟
# url3="https://0e15-2001-b400-e339-80f8-cdfa-1872-3160-73a7.jp.ngrok.io/RESTapiApp/SMS_3/"
# data={
#     'RuserID': 'UserID-59d0094e-48b6-4700-a45b-63ba7e927593',
#     'Raccess_code' :'Access-0c824128-1bc1-41e6-ae88-6ebc8e752ccb'
# }
# r = requests.get(url3,data,headers={'Authorization':'Token 84d880fe428b979e089e05847c5a3c7b20e3d2d0'})
# if r.status_code == 200:
#     print(r.json()) 
# else:
#         print("Error from server: " + str(r.content))
